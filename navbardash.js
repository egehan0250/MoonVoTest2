     ...
     let dashnav = `
            ...
            <ul class="nav-menus">
              ...
              <li class="profile-nav onhover-dropdown pe-0 py-0 me-0">
                ...
                <ul class="profile-dropdown onhover-show-div">
                  <li><a href="/my/profil"><i data-feather="user"></i><span>Hesap </span></a></li>
                  <li><a href="/my/tickets"><i data-feather="mail"></i><span>Destek Taleplerim</span></a></li>
                  <li><a href="/my/servers"><i data-feather="file-text"></i><span>Sunucularım</span></a></li>
                  <li><a href="#bakım"><i data-feather="settings"></i><span>Hesap Ayarları</span></a></li>
      ...
      <div class="page-body-wrapper">
        ...
        <div class="sidebar-wrapper"> 
          <div>
            <div class="logo-wrapper"><a href="index.html"><img class="img-fluid for-light" src="https://i.hizliresim.com/dstx6l2.png" alt=""><img class="img-fluid for-dark" src="https://i.hizliresim.com/gi1ej4o.png" alt=""></a>
              ...
              <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                  ...
                  <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#">
                      ...
                      </svg><span>Keşfet</span></a>
                    <ul class="sidebar-submenu">
                      <li><a href="/top50sunucu">Top 50 sunucular</a></li>
                           <li><a href="/searchserver">Sunucu arat</a></li>
                    </ul>
                  </li>
                  <li class="sidebar-list"><label class="badge badge-light-danger">Bakım</label><a class="sidebar-link sidebar-title" href="#">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g> 
                          <g> 
                    ...
                    <ul class="sidebar-submenu">
                      <li><a href="/my/profil">Profil</a></li>
                      <li><a href="edit-profile.html">Profil ayarları</a></li>
                      <li><a href="user-cards.html">Profil arat</a></li>
                      <li><a href="/my/servers">Sunucularım</a></li>
                    </ul>
                  </li>
                   <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      </svg><span>Fiyatlandırma</span></a>
                    <ul class="sidebar-submenu">
                      <li><a href="/pricing">Plan satın al</a></li>
                      <li><a href="/balance">Bakiye yükle</a></li>
                    </ul>
                  </li>
                  <li class="sidebar-list"><label class="badge badge-light-danger">Bakım</label><a class="sidebar-link sidebar-title link-nav" href="faq.html">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g> 
                          <g> 
                      ...
                      </svg><span>SSS</span></a></li>
               
                  <li class="sidebar-list"><label class="badge badge-light-danger">Bakım</label><a class="sidebar-link sidebar-title link-nav" href="/my/tickets">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g> 
                          <g>
                      ...
                      </svg><span>Destek Talepi</span></a></li>
                    <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g> 
                          <g> 
                ...
                <div class="sidebar-img-section">
                  <div class="sidebar-img-content"><img class="img-fluid" src="/Zetaadmindash/assets/images/side-bar.png" alt="">
                    <h4>Need Help?</h4><a class="txt" href="https://mail.google.com/mail/u/1/?pli=1#inbox?compose=CllgCJNsMWXRNNSFjMgSfvlRvRZbNlcVjJkfsVDPnVLSHqRVHcgncFtjHLFWsNDkvVgsGGXNTLq">Bize ulaş "support@moonvo.me"</a><a class="btn btn-secondary" href="https://discord.gg/9TyEZnqfVV">Discord</a>
                  </div>
                </div>
              </div>
